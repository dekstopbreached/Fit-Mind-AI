...
export default function Login() {
  ...
  // Already logged in — send to the right panel immediately
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      // Admins always land in the Admin Panel; customers go to their original destination.
      const defaultDest = loggedInUser.isAdmin ? "/admin" : "/dashboard";
      const dest = loc.state?.from && !loc.state.from.startsWith("/admin") && !loggedInUser.isAdmin
        ? loc.state.from
        : defaultDest;
